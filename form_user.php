...
<head>
  ...
  <script> 
    ...
    $(".bot").click(function(){  // เมื่อคลิก checkbox  ใดๆ  
      if($(this).prop("checked")==true){ // ตรวจสอบ property  การ ของ   
        var indexObj=$(this).index(".bot"); //   
        $(".bot").not(":eq("+indexObj+")").prop( "checked", false ); // ยกเลิกการคลิก รายการอื่น  
      }  
    }); 
                ...
                <fieldset>
                  <div class="alert alert-danger">
                    ...
                    <div class="form-gruop" id="elect">
                      <p class="mx-2 px-2 ">
                        <input type="checkbox" class= "bot"   name="values_type[]"  value="หลอดไฟ"> หลอดไฟ <br>
                        <input type="checkbox" class= "bot"   name="values_type[]"  value="ปลั๊กไฟ"> ปลั๊กไฟ <br>
                        <input type="checkbox" class= "bot"   name="values_type[]"  value="แอร์"> แอร์ <br>
                        <input type="checkbox" class= "bot"   name="values_type[]"  value="พัดลม"> พัดลม<br>
                        <input type="checkbox" class= "bot"   name="values_type[]"  value="พัดลมดูดอากาศ"> พัดลมดูดอากาศ<br>
                        <input type="checkbox" class= "bot"   name="values_type[]"  value="เครื่องใช้ไฟฟ้า(ของวิทยาเขต)"> เครื่องใช้ไฟฟ้า(ของวิทยาเขต)<br><br>
                        <textarea name="values_type[]" class= "bot"   rows="4" cols="30" class="form-control" placeholder=" อื่นๆ (ระบุ)"></textarea> <br>
                      </p>
                    </div>

                    <div class="form-gruop" id="san">
                      <p class="mx-2 pl-2 ">
                        <input type="checkbox" class= "bot"   name="values_type[]"  value="ประตู">ประตู </a><br>
                        <input type="checkbox" class= "bot"   name="values_type[]"  value="หน้าต่าง"> หน้าต่าง <br>
                        <input type="checkbox" class= "bot"   name="values_type[]"  value="กระเบื้อง"> กระเบื้อง <br>
                        <input type="checkbox" class= "bot"   name="values_type[]"  value="ฝ้าเพดาน"> ฝ้าเพดาน <br>
                        <input type="checkbox" class= "bot"   name="values_type[]"  value="ผนัง"> ผนัง <br>
                        <input type="checkbox" class= "bot"   name="values_type[]"  value="สี"> สี <br>
                        <input type="checkbox" class= "bot"   name="values_type[]"  value="ท่อนํ้า"> ท่อนํ้า <br>
                        <input type="checkbox" class= "bot"   name="values_type[]"  value="สุขภัณฑ์"> สุขภัณฑ์ <br>
                        <input type="checkbox" class= "bot"    name="values_type[]"  value="นํ้าฝนรั่ว"> นํ้าฝนรั่ว<br><br>
                        <textarea name="values_type[]"  class= "bot"   rows="4" cols="30" class="form-control" placeholder="อื่นๆ (ระบุ)"></textarea> <br>
                      </p>
                    </div>
                    ...
                    <div class="form-gruop" id="office">
                      <p class="mx-2 px-2 ">
                        <input type="checkbox" class= "bot"   name="values_type[]"  value="เก้าอี้" > เก้าอี้ </a>  <br>
                        <input type="checkbox" class= "bot"   name="values_type[]"  value="โต๊ะ">  โต๊ะ  </a> <br>
                        <input type="checkbox" class= "bot"   name="values_type[]"  value="ตู้"> ตู้  <br>
                        <input type="checkbox" class= "bot"   name="values_type[]"  value="งานโลหะ/ไม้"> งานโลหะ/ไม้ <br><br>
                        <textarea name="values_type[]" class= "bot"   rows="4" cols="30" class="form-control" placeholder="อื่นๆ (ระบุ)"></textarea> <br>
                      </p>
                    </div>
